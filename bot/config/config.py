...
# настройки ниже лучше не трогать
    ...
    TASKS_TODO_LIST: list[str] = ["solitaireGame", "tonDurakGame", "frogApp", "tonPoker", "flappyBird","x:notcoin", "x:notpixel", "pumpkin", "nikolai", "paint20pixels", "leagueBonusSilver", "leagueBonusGold", "leagueBonusPlatinum", "boinkTask", "makePixelAvatar", "jettonTask", "channel:notpixel_channel", "channel:notcoin", "joinSquad"]
